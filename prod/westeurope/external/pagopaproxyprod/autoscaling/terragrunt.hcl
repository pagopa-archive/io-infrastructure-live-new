...
terraform {
  source = "git::git@github.com:pagopa/io-infrastructure-modules-new.git//azurerm_monitor_autoscale_setting?ref=update-azurerm-v2.87.0"
}

inputs = {
  name = "autoscaling-pagopaproxyprod"
