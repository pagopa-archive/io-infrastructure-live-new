...
dependency "app_service_certificate" {
  config_path = "../../../common/app_service_certificate"
}
...
terraform {
  source = "git::git@github.com:pagopa/io-infrastructure-modules-new.git//azurerm_app_service_custom_domain?ref=v0.0.41"
}
