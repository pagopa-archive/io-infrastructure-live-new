...
terraform {
  # source = "git::git@github.com:pagopa/io-infrastructure-modules-new.git//azurerm_virtual_network_gateway?ref=v0.0.47"
  source = "../../../../../../io-infrastructure-modules-new/azurerm_virtual_network_gateway"
}
