...
# App Backend Api
dependency "functions_app2_r3" {
  config_path = "../../../internal/api/functions_app2_r3/function_app"
}
...
inputs = {
  ...
  app_settings_secrets = {
    ...
    map = {
      ...
      // ZENDESK
      ALLOW_ZENDESK_IP_SOURCE_RANGE="appbackend-ALLOW_ZENDESK_IP_SOURCE_RANGE"
      JWT_ZENDESK_SUPPORT_TOKEN_SECRET="appbackend-JWT_ZENDESK_SUPPORT_TOKEN_SECRET"
    }
  }
