  ...
  global_delivery_rule = {
    ...
    modify_response_header_action = [{
      ...
      # Content-Security-Policy (in Report mode)
      {
        ...
        value  = "default-src 'self'; script-src 'report-sample' 'self'; style-src 'report-sample' 'self'; object-src 'none'; base-uri 'self'; connect-src 'self' https://api.io.italia.it; font-src 'self'; frame-src 'self'; img-src 'self' data:; manifest-src 'self'; media-src 'self'; worker-src 'none'"
    }]
