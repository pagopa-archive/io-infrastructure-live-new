...
dependency "cdn_endpoint_websiteassets" {
  config_path = "../cdn_endpoint_websiteassets"
}
...
inputs = {
  ...
  endpoint = {
    name     = dependency.cdn_endpoint_websiteassets.outputs.resource_name
    hostname = dependency.cdn_endpoint_websiteassets.outputs.hostname
  }
}
