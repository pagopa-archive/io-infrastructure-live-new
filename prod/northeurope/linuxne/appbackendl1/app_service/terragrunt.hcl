...
dependency "functions_app1_r3" {
  config_path = "../../../../westeurope/functions_app1/functions_app1_r3/function_app"
}

# Bonus Api
dependency "functions_bonus" {
  config_path = "../../../../westeurope/internal/api/functions_bonus/function_app"
}

# Push notifications origin
dependency "subnet_fn3services" {
  config_path = "../../../../westeurope/internal/api/functions_services_r3/subnet"
}

# Session endpoints allowed origin
dependency "subnet_funcadmin_r3" {
  config_path = "../../../../westeurope/internal/api/functions_admin_r3/subnet"
}

# External
dependency "subnet_appgateway" {
  config_path = "../../../../westeurope/external/appgateway/subnet"
}

dependency "app_service_pagopaproxyprod" {
  config_path = "../../../../westeurope/external/pagopaproxyprod/app_service"
}

dependency "app_service_pagopaproxytest" {
  config_path = "../../../../westeurope/external/pagopaproxytest/app_service"
}

# Common
dependency "application_insights" {
  config_path = "../../../../westeurope/common/application_insights"
}

dependency "key_vault" {
  config_path = "../../../../westeurope/common/key_vault"
}
...
dependency "redis" {
  config_path = "../../../../westeurope/common/redis/redis_cache"
}

dependency "notification_hub" {
  config_path = "../../../../westeurope/common/notification_hub"
}

dependency "storage_account_logs" {
  config_path = "../../../../westeurope/operations/storage_account_logs/account"
}

dependency "storage_queue_spid_logs" {
  config_path = "../../../../westeurope/operations/storage_queue_spid_logs"
}

dependency "storage_queue_users_login" {
  config_path = "../../../../westeurope/operations/storage_queue_users_login"
}

dependency "notification_queue" {
  config_path = "../../../../westeurope/internal/api/storage_notifications/queue_push-notifications"
}

dependency "notification_storage_account" {
  config_path = "../../../../westeurope/internal/api/storage_notifications/account"
}
